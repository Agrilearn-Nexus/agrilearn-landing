...
import { GrOrganization, GrLocation, GrCalendar } from "react-icons/gr";
      ...
      <div className="w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-[#3F7A5A] text-white flex flex-col items-center py-10 px-4 text-center">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-sm font-bold text-2xl">
              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-gray-800">+91 7488468326</p>
                  </div>
                </div>
