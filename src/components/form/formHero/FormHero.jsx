...
const FormHero = () => {
  return (
    <div className="w-11/12 md:w-10/12 mx-auto flex flex-col items-center justify-center text-white gap-6 md:gap-8">
      ...
      <p className="animate-fade-in-up delay-200 text-lg md:text-xl lg:text-2xl w-full md:w-3/4 lg:w-2/3 text-center text-white leading-relaxed">
      ...
      <div className="animate-fade-in-up delay-300 flex flex-col md:flex-row gap-4 w-full md:w-auto mt-4">
        <a href="#registerNow" className="group relative overflow-hidden text-lg font-bold py-3 px-8 bg-[#E8BA30] rounded-xl text-black flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(232,186,48,0.6)]">
