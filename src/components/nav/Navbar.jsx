...
const Navbar = () => {
  ...
  const navLinks = [ "services", "objective", "vision", "contact"];
  ...
  return (
    <nav className="relative z-[100]">
      ...
      >
        <div className="absolute top-[-10%] right-[-10%] w-64 h-64 bg-green-600/20 rounded-full blur-3xl pointer-events-none"></div>
