  ...
  const mainObjectives = [
    {
      ...
      description: "We provide offline and online training to train professionals for the Industry, teaching them the latest techniques.",
    },
    {
      icon: <Handshake size={40} />,
      title: "Collaborating",
      description: "We cooperate and collaborate with institutions having similar objectives to hold seminars, conferences and discussions.",
    },
    {
      icon: <Microscope size={40} />,
      title: "Promotion of Research",
      description: "AEEFWS is mainly engaged in the promotion of research in the field of Agricultural and Allied Science.",
    },
    {
      icon: <HandHelping size={40} />,
      title: "Providing Assistance",
      description: "We are actively helping research workers by providing financial and other help.",
    },
    {
      icon: <GraduationCap size={40} />,
      title: "Educating Young Minds",
      description: "We believe the first step of society in the right direction would come from educating and motivating young minds.",
    },
    {
      icon: <Users size={40} />,
      title: "Build Community",
      description: "Foster a network of agricultural professionals, researchers, and farmers working together.",
    },
  ];
