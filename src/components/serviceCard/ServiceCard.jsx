...
const ServiceCard = ({ value }) => {
    return (
        <div className="group w-full flex flex-col gap-6 p-8 bg-[#F9F9F5] rounded-2xl relative overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_-15px_rgba(46,96,65,0.15)] hover:-translate-y-2 border border-transparent hover:border-[#E8BA30]/20">
            ...
            <div className="relative z-10 flex flex-col gap-4 flex-grow">
                <h1 className="text-2xl font-serif font-bold text-[#16261E] group-hover:text-[#2E6041] transition-colors">
                    {value.title}
                </h1>
                ...
                <div className="mt-auto pt-4 flex items-center gap-2 cursor-pointer">
